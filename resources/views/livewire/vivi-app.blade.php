        ...
        @foreach ($this->locations as $location)
            <div
                ...
                @if ($location->emergencyType?->img)
                    <img src="{{ $location->emergencyType->img }}" alt="Emergency Type Image"
                        class="absolute inset-0 w-full h-full object-cover">
                @else
                    <svg class="absolute inset-0 size-full stroke-gray-900/20 dark:stroke-neutral-100/20"
                        fill="none">
                        <defs>
                            <pattern id="pattern-6827711a3f39a" x="0" y="0" width="8" height="8"
